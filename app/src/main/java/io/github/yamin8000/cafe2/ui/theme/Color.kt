/*
 *     Cafe/Cafe.app.main
 *     Color.kt Copyrighted by Yamin Siahmargooei at 2022/12/9
 *     Color.kt Last modified at 2022/12/9
...
package io.github.yamin8000.cafe2.ui.theme

import androidx.compose.ui.graphics.Color

val md_theme_light_primary = Color(0xFF9C4239)
...
val md_theme_light_surfaceTint = Color(0xFF9C4239)
val md_theme_light_outlineVariant = Color(0xFFD8C2BF)
val md_theme_light_scrim = Color(0xFF000000)

val md_theme_dark_primary = Color(0xFFFFB4AB)
val md_theme_dark_onPrimary = Color(0xFF5F1410)
val md_theme_dark_primaryContainer = Color(0xFF7D2B24)
...
val md_theme_dark_inversePrimary = Color(0xFF9C4239)
...
val seed = Color(0xFF4C3330)
val FirstHarmony = Color(0xFFFF730E)
val light_FirstHarmony = Color(0xFF9E4300)
val light_onFirstHarmony = Color(0xFFFFFFFF)
val light_FirstHarmonyContainer = Color(0xFFFFDBCB)
val light_onFirstHarmonyContainer = Color(0xFF341100)
val dark_FirstHarmony = Color(0xFFFFB691)
val dark_onFirstHarmony = Color(0xFF552100)
val dark_FirstHarmonyContainer = Color(0xFF783100)
val dark_onFirstHarmonyContainer = Color(0xFFFFDBCB)