...
import io.github.yamin8000.cafe.ui.drawable.DrawableAdapter
import io.github.yamin8000.cafe.ui.drawable.Utility.getIconPack
...
class AddCategoryModal : BottomSheetDialogFragment() {
    ...
    private fun handleCategoryDataConfirmation() {
        ...
        if (categoryName.isNullOrBlank()) {
            binding.categoryNameEdit.error = getString(R.string.please_enter_category)
